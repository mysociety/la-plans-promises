...
custom:
  ...
  datasette:
    ...
    about_url: https://mysociety.github.io/la_plans_promises/datasets/local_authority_climate_emergency_declarations/0_3_9
  formats:
    csv: true
    parquet: true
resources:
- title: Local authority climate emergency declarations
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://mysociety.github.io/la_plans_promises/datasets/local_authority_climate_emergency_declarations/0_3_9#declarations
  ...
  schema:
    ...
    - name: combined-authority
      ...
      constraints:
        unique: false
      example: CPCA
  hash: 05331a3c11719b392a86bd6eae25adc4
full_version: 0.3.9
