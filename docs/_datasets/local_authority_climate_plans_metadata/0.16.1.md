...
custom:
  ...
  datasette:
    ...
    about_url: https://mysociety.github.io/la_plans_promises/datasets/local_authority_climate_plans_metadata/0_16_1
  formats:
    csv: true
    parquet: true
resources:
- title: Local authority climate plans metadata
  ...
  custom:
    ...
    datasette:
      about: Info & Downloads
      about_url: https://mysociety.github.io/la_plans_promises/datasets/local_authority_climate_plans_metadata/0_16_1#plans
  path: plans.csv
  name: plans
  ...
  schema:
    ...
    - name: combined-authority
      ...
      constraints:
        unique: false
      example: CPCA
  hash: 5db4585bb0e6c8bcacc69f5a47083314
full_version: 0.16.1
permalink: /datasets/local_authority_climate_plans_metadata/0_16_1
---
